...
public class LoginPageSwing extends JFrame {
    ...
    private JPanel createLoginPanel() {
        ...
        // Error Label - Fixed position to prevent layout shifts
        gbc.gridx = 0;
        gbc.gridy++;
        gbc.gridwidth = 2;
        gbc.anchor = GridBagConstraints.CENTER;
        ...
        loginErrorLabel.setPreferredSize(new Dimension(300, 20)); // Fixed height to prevent layout shifts
        ...
        loginButton.addActionListener(e -> {
            ...
            if (login(erno, pass)) {
                ...
                loginErrorLabel.setText("Invalid credentials. Please check enrollment no and password.");
